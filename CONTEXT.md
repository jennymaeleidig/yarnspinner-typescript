...
- **Storylet**: the Try site's presentation name for a node-group member drawn by saliency; site-layer vocabulary, not upstream's — the glossary term for the thing being drawn is **node-group member**.
