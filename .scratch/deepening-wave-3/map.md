...
|---|--------|-----------|--------|
| 01 | [01-fallback-set-failure-signal.md](issues/01-fallback-set-failure-signal.md) | Ticket 10 re-filed: fallback `<<set>>` undefined-evaluation clobbers storage (result wrapper) | open |
| 02 | [02-bytecode-slice-runner.md](issues/02-bytecode-slice-runner.md) | One bytecode-slice runner inside the VM; op classes move beside their emitter | open |
